...
app.get("/subitrair/a/b", function(req,res){            //quando recer uma requisação em hello e vai fazer o q é mandado aqui 
    res.send("a - b =" +  calc.subitrair(a,b));
})

app.get("/multiplicar/a/b", function(req,res){            //quando recer uma requisação em hello e vai fazer o q é mandado aqui 
    res.send("a * b =" +  calc.multiplicar(a,b));
})

app.get("/dividir/a/b", function(req,res){            //quando recer uma requisação em hello e vai fazer o q é mandado aqui 
